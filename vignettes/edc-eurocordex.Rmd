---
title: "Euro-Cordex Data for Europe"
author: "RS-eco"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Euro-Cordex Data for Europe}
...
The datasets (*cordex_bioclim_eur.rda, cordex_bioclim_eur_p44deg.rda*) just contains the data of three 30-year time periods (**1991-2020, 2041-2070, 2071-2100**) and consists of 27 columns with the following names:
...
Here, I perform a first analysis of the Euro-Cordex bias-adjusted temperature and precipitation data for Europe at 0.11 degree (EUR-11, ~12.5 km).

The Euro-Cordex data for Europe (cordex_bioclim_eur.rda, cordex_bioclim_eur_p44deg.rda), which I use here, can be downloaded from https://github.com/RS-eco/edc/blob/master/data/.

The code for how the Euro-Cordex data (cordex_bioclim_eur.rda, cordex_bioclim_eur_p44deg.rda) was created can be found here: https://github.com/RS-eco/edc/blob/master/data-raw/euro_cordex_eur.R
...
**Fig. 10.** Change (top) and relative change (bottom) of bio12 until 2041-2070 for the three rcps (RCP2.6, RCP4.5, RCP8.5).
